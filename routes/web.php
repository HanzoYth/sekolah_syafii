...
Route::post("/reg/rst",[akunController::class,"ResetSandiPassword"]);
...
//ini otp
Route::get("/gr/totp",[otpController::class,"tampilan_otp"]);
...
//ini dasboard siakad
Route::get('/sk/das',[siakadController::class,"dashboard_siakad"]);
