...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/welcome.css') }}?v={{ filemtime(base_path('css/welcome.css')) }}">
</head>
<body>
    ...
    <!-- ======== HERO SECTION ======== -->
    <section id="home" class="hero" style="--hero-bg: url('{{ asset('public/img/ft_1.jpeg') }}');">
        <div class="container">
