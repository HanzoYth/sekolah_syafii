...
return new class extends Migration
{
    ...
    {
        Schema::create("master_absensi_operator",function (Blueprint $table){
            $table->id();
            ...
            $table->foreignId("operator_id")->constrained("operator")->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists("master_absensi_operator");
    }
};
